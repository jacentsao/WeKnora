export default {
  ...
  datasource: {
    ...
    noResourcesDesc_confluence: 'No Confluence spaces found. Please create a Space in Confluence first and ensure your account has access.',
    ...
    guideStep3_notion: 'Search and select your Integration app, then come back and click Retry',
        guideStep1_confluence: 'Log in to Confluence and navigate to the Space you want to sync',
        guideStep2_confluence: 'Make sure your account has "View" permission for that Space',
        guideStep3_confluence: 'If you don\'t have a Space yet, create one in Confluence first, then click Reload',
    ...
    connectorDesc: {
      ...
      confluence: 'Sync pages from Atlassian Confluence as PDF',
    },
    drive: {
    ...
    field: {
      ...
      confluenceEditionLabel: 'Confluence Edition',
    ...
    prereqBarText_yuque: 'First time? Click to see the Yuque token setup guide',
        prereqBarText_confluence: 'First time? Click to see the Confluence setup guide',
    ...
    prereqOpenConsole_yuque: 'Open Yuque Token settings',
        prereqStep1Brief_confluence: 'Get Confluence access credentials',
        prereqStep1Desc_confluence: 'Server/DC: use username and password; Cloud: use email and API Token',
        prereqStep2Brief_confluence: 'Confirm Space access',
        prereqStep2Desc_confluence: 'Ensure your account has view access to at least one Confluence Space',
        prereqStep3Brief_confluence: 'Ensure at least one Space exists',
        prereqStep3Desc_confluence: 'If you don\'t have a Space yet, create one in Confluence first',
